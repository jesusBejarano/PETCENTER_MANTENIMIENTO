	...
	return this.each( function() {
		...
		populate = function (npage) {
			if(!ts.grid.hDiv.loading) {
				...
				case "xml":
				case "script":
                    var paginacionDTO = new Object(); 
                    paginacionDTO._search = ts.p.postData["_search"];
                    paginacionDTO.nd = ts.p.postData["nd"];
                    paginacionDTO.page = ts.p.postData["page"];
                    paginacionDTO.rows = ts.p.postData["rows"];
                    paginacionDTO.sidx = ts.p.postData["sidx"];
                    paginacionDTO.sord = ts.p.postData["sord"];
                    ts.p.postData.paginacionDTO=paginacionDTO;
